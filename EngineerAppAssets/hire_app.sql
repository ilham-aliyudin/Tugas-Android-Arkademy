...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Okt 2020 pada 03.56
...
CREATE TABLE `hire` (
  ...
  `statusConfirm` enum('delayed','accepted','rejected') NOT NULL,
...
CREATE TABLE `worker` (
  `idWorker` int(11) NOT NULL,
  `nameWorker` varchar(100) DEFAULT NULL,
...
--
ALTER TABLE `hire`
  MODIFY `idHire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
